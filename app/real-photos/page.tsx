...
export default function RealPhotosPage() {
  ...
  useEffect(() => {
    // Fetch list of images from the real folder
    fetch("/api/images/real")
      .then((res) => res.json())
      .then((data) => {
    ...
    <div className="space-y-8 fade-in">
      ...
      <section className="dos-box p-6">
        <h1 className="text-4xl md:text-5xl text-glow mb-4">
          [REAL_PHOTOGRAPHY.DIR]
        </h1>
        <p className="text-lg md:text-xl text-terminal-dim">
          Real-world moments captured through the lens
        </p>
